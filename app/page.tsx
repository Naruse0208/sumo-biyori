  ...
  return (
    <main>
      ...
      <div className="notice-bar">
        <span>令和八年 七月場所</span>
        <strong>名古屋場所・十三日目</strong>
        <span className="notice-detail">幕内取組を、見どころとともに。</span>
      </div>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-core">
          ...
          <article className="bout-card" id="torikumi">
            <div className="bout-ribbon">七月場所・十三日目　注目取組</div>
            <div className="bout-main">
              <div className="wrestler wrestler-east">
                <span>東・横綱</span>
                <strong>豊昇龍</strong>
                <small>鋭い踏み込みと投げの勘</small>
              </div>
              <div className="versus" aria-label="対">対</div>
              <div className="wrestler wrestler-west">
                <span>西・大関</span>
                <strong>琴櫻</strong>
                <small>前へ出続ける正攻法の圧力</small>
              </div>
            </div>
            <div className="bout-foot">
              <span>見どころ　低い立ち合い</span>
              <span>観戦メモ　寄り切りの攻防</span>
              <a href="#guide">一番の見方 →</a>
            </div>
          </article>
        </div>
